--creationg tables for PH-EmployeesDB
...
--create new table that has retirment eligible ppl who are still with company
SELECT ri.emp_no,
    ri.first_name,
	ri.last_name,
    de.to_date
...
select * from deliverable_pt1;
--DELIVERABLE 1 pt2
SELECT DISTINCT ON (del.emp_no) del.emp_no,
	del.first_name,
	del.last_name,
	del.title,
	del.to_date
INTO unique_titles
FROM deliverable_pt1 as del
ORDER BY del.emp_no, del.to_date DESC;
